    ...
    <div className="w-64 bg-gray-800 text-white p-4 flex flex-col h-screen fixed left-0 top-0">
      ...
      <nav className="flex-grow">
        <ul className="space-y-2">
          ...
          <li><Link href="/compare" className="block py-2 px-4 hover:bg-gray-700 rounded">Compare </Link></li>
          <li><Link href="/teams" className="block py-2 px-4 hover:bg-gray-700 rounded">Teams </Link></li>
        </ul>
      </nav>
      {user && (
        <button
